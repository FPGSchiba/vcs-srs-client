...
var (
	...
	// PROP_* / IPROP_* are PropID sentinels (see device_windows.go), not
	// real GUIDs -- DirectInput's MAKEDIPROP idiom repurposes small
	// integers as a REFGUID for predefined properties. Plain uintptr
	// conversion here means no unsafe.Pointer is involved at all.
	PROP_BUFFERSIZE         = PropID(1)
	PROP_AXISMODE           = PropID(2)
	PROP_GRANULARITY        = PropID(3)
	PROP_RANGE              = PropID(4)
	PROP_DEADZONE           = PropID(5)
	PROP_SATURATION         = PropID(6)
	PROP_FFGAIN             = PropID(7)
	PROP_FFLOAD             = PropID(8)
	PROP_AUTOCENTER         = PropID(9)
	PROP_CALIBRATIONMODE    = PropID(10)
	PROP_CALIBRATION        = PropID(11)
	PROP_GUIDANDPATH        = PropID(12)
	PROP_INSTANCENAME       = PropID(13)
	PROP_PRODUCTNAME        = PropID(14)
	PROP_JOYSTICKID         = PropID(15)
	PROP_GETPORTDISPLAYNAME = PropID(16)
	IPROP_PHYSICALRANGE     = PropID(18)
	PROP_LOGICALRANGE       = PropID(19)
	PROP_KEYNAME            = PropID(20)
	PROP_CPOINTS            = PropID(21)
	PROP_APPDATA            = PropID(22)
	PROP_SCANCODE           = PropID(23)
	PROP_VIDPID             = PropID(24)
	PROP_USERNAME           = PropID(25)
	PROP_TYPENAME           = PropID(26)
)
