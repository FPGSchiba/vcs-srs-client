...
// keyTable maps our canonical key names to golang.design/x/hotkey's Windows
// virtual-key constants. As on the other platforms, the library only exposes
// a limited key set (letters, digits, a handful of named keys, arrows, and
...
// by golang.design/x/hotkey on Windows.
